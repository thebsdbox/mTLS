...
func main() {
	...
	flag.StringVar(&sidecarConfigFile, "sidecar-config-file", "sidecarconfig.yaml", "Sidecar injector configuration file.")
	...
	err = createOrUpdateMutatingWebhookConfiguration(caPEM, webhookServiceName, webhookNamespace, kubeconfig)
	if err != nil {
